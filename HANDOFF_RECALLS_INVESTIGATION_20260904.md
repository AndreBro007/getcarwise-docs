...
- ~~Match-score differentiation~~ — **DONE, Sep 7, 2026.** Shipped as V2.4 (continuous price-proximity scoring + modest Used-value tie-break), merged into `release/v2`, live-confirmed in production on both Claude and ChatGPT. See `STATUS_V2.4_MATCH_SCORE_IMPLEMENTATION_20260907.md` and `DECISIONS.md` `SYS-20260907-003`. A separate, unrelated bug (New/Used mislabeling in the host-facing text) was found live during this work and fixed too (V2.5).
